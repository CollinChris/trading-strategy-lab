...
- [ ] Run all five on the Alpaca paper account for 2+ weeks; compare paper fills vs backtest
- [ ] Parameter sweeps with train/test splits (does anything survive out-of-sample?)
